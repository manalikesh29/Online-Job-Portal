...
<head>
	...
	<title>Naukri Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Naukri Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Prayagraj, <br/> 73U/43, <br/>George Town</address>
								</li>
								<li>
										<h5>Email</h5><a href="manali:Naukri.kesh@gmail.com">manali.kesh@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233546607474">+91 1234567890</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Naukri Jobs</h5>
											<p>Naukri Jobs is a job portal, online job management system developed by Manali Kesharwani for her project in May 2024.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Naukri Jobs Contact</h5>
								
								<p>Address : Prayagraj, George Town, 73U/43</p>
								<p>Email : <a href="manali:Naukri.kesh@gmail.com">manali.kesh@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Naukri Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Manali Kesharwani</a></li>
								</ul>
